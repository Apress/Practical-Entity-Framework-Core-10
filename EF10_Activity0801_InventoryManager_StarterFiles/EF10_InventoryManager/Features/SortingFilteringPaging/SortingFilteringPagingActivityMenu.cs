...
public class SortingFilteringPagingActivityMenu
{
    ...
    private async Task<List<Item>> ListItemsThenOrderAndTake()
    {
        ...
        //TODO: Replace with code from Listing 8-6
        var items = new List<Item>(); // remove this line
        return items;
    }
    ...
    private async Task<List<Item>> OrderItemsThenTakeAndList()
    {
        ...
        //TODO: Replace with code from Listing 8-7
        var items = new List<Item>(); // remove this line
        return items;
    }
    ...
    private async Task<List<Item>> FilterItemsByUserInput(string userInput)
    {
        ...
        //TODO: Replace with code from Listing 8-10
        var items = new List<Item>(); // remove this line
        return items;
    }
    ...
    {
        //TODO: Replace this line with code from Listing 8-12
        var items = new List<ItemDetailSummaryDTO>(); // remove this line
        return items;
    }
    ...
    private async Task FilterItemsByUserInputUsingViewAndPaging(string userInput)
    {
        ...
        while (keepGoing)
        {
            //TODO: Replace these four lines of code with the code from Listing 8-14 [line 1]
            keepGoing = false;                                  //remove this [line 2]
            var pageResults = new List<ItemDetailSummaryDTO>(); //remove this [line 3]
            return;                                             //remove this [line 4]
    ...
    private async Task RunAsNoTrackingDemo()
    {
        ...
        //TODO: Listing 8-16 goes here:
        var itemDetail = new Item(); // remove this line
        ...
        //TODO: Listing 8-17 goes here:
        var itemDetailUpdated = new Item(); // remove this line
