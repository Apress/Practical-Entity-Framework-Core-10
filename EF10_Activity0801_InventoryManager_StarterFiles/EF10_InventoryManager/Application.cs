...
public class Application
{
    ...
    {
        _db = context;
        _menu = new MainMenu(_db, _lineLength);
    }
    ...
    //Note: Additional methods were removed from this version forward as they are no longer used for the remainder of the book
}
