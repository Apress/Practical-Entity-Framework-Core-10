# Listing 04-17: Make the call to UpdateAllCurrentValue

Use the following code to call the `UpdateAllCurrentValue` method.

## The code

Use the following code to call a method called `UpdateAllCurrentValue` to set all items to have a current value.
...
Here is the full code from the Application.cs file:
