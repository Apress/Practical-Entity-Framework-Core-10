...
{
  "ConnectionStrings": {
    "InventoryDbConnection": "Server=localhost;Database=InventoryManagerDB_1002;User Id=sa;Password=Password#123!;TrustServerCertificate=True;MultipleActiveResultSets=False;Column Encryption Setting=Enabled;"
  }
}
```  