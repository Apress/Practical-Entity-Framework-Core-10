# Listing 14-3 - Add the interceptors to the DbContext

Use the host builder to add the interceptors when configuring the DbContext

## The Code

Review how the AddInterceptor command is used during the configuration of the dbcontext builder
...
Here is the full program.cs file with the full host section
