# Listing 14-2: The SoftDeleteInterceptor

The Soft delete interceptor is responsible for making sure nothing is ever truly deleted.

## The code

Review the soft delete interceptor below:
