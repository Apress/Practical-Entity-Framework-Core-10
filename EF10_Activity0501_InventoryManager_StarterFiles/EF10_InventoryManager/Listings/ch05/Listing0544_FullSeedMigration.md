# Listing 5-44: Full Seed Migration

Use this to review the migration for adding all seed data to the database. 
This migration is created after adding all the seed data to the `OnModelCreating` method of the `InventoryDbContext` class.
