...
public class CreateOperationsMenu
{
    ...
    //{
    //    /* Used the code from Listing 6-10 to add a single Category */
    ...
    {
        /* Used the code from Listing 6-14 to complete this method*/
    ...
    {
        /* Used the code from Listing 6-17 to complete this method*/
        ...
        return contributorsToAdd.Count == result;
    }
