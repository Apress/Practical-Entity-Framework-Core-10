...
public class Application
{
    ...
    public Application(InventoryDbContext context, IMapper mapper, IItemService itemService
                            ...
                            , IGenreService genreService, IParserService parserService)
    {
        _db = context;
        _mapper = mapper;
        _menu = new MainMenu(context, _lineLength, _mapper, itemService, category, contributorService, genreService, parserService);
    }
